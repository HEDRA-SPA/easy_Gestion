...
const Dashboard = ({ 
  ...
  // 🔥 Calcular meses basado en periodoActual que viene del padre (datos reales)
  ...
  // 🔥 FUNCIÓN MANUAL para aplicar filtro (SIN useEffect)
  const handleBuscar = () => {
      ...
      {vista === 'operacion' && (
        <>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-end bg-white p-4 rounded-2xl border border-gray-100 shadow-sm w-fit">
            ...
            {/* 🔥 BOTÓN BUSCAR - Control total manual */}
            <button 
